# Experiment 29d: Hug vs Hug+Hop on Epanechnikov kernel Gaussian prior.
import numpy as np
...
def log_abc_posterior(xi, epsilon, target, z0):
    ...
    return logprior_normal(xi) + log_epanechnikov_kernel(xi, epsilon, target, z0)
