...
save("experiment11b/EPSILONS.npy", epsilons)
save("experiment11b/ALPHAS.npy", alphas)

save("experiment11b/ESS_HUG.npy", uESS_HUG)
save("experiment11b/ESS_LOGPI_HUG.npy", ESS_LOGPI_HUG)
save("experiment11b/A_HUG.npy", A_HUG)
save("experiment11b/RMSE_HUG.npy", RMSE_HUG)

save("experiment11b/ESS_THUG.npy", uESS_THUG)
save("experiment11b/ESS_LOGPI_THUG.npy", ESS_LOGPI_THUG)
save("experiment11b/A_THUG.npy", A_THUG)
save("experiment11b/RMSE_THUG.npy", RMSE_THUG)