# Experiment 29e: Hug vs Hug+Hop on Epanechnikov kernel and mixture of normals prior.
import numpy as np
...
def experiment(x00, T, B, N, lam, kappa, epsilon, q, target, z0, mus, Sigmas, coefs):
...
if __name__ == "__main__":
    ...
    epsilons = [0.1, 0.0001, 0.0000001] #[0.1, 0.001, 0.00001, 0.0000001]
    ...
    for i in range(n_runs):
        ...
        for j, epsilon in enumerate(epsilons):
            ...
            for k, T in enumerate(Ts):
                out = experiment(initial_point, T, B, N, lam, kappa, epsilon, q, target, z0, mus, Sigmas, coefs)
