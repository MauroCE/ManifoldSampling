...
class GaussianTargetHMC:
    """
    HMC algorithm using Leapfrog integration and using a Euclidean-Gaussian kinetic energy. That is
    p ~ N(0, M) where M does not depend on q. This only works for the uniform under the area of a Gaussian 
    distribution.
    """
