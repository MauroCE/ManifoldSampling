"""
Debug version of Zappa. Returns all sorts of things and you can change the type of projector.
"""
...
def zappa_sampling_storeall(x0, manifold, logf, logp, n, sigma, tol, a_guess, root=None, maxiter=50):
    """
    ...
    vs_x = []
    vs_y = []
    # Successes (redundant, contanted in statuses)
    successes_x = []
    successes_y = []
    # Store log acceptance ratios
    logaps = []
    ...
    output = {
        ...
        'vsx': vs_x,
        'vsy': vs_y,
        'successes_x': successes_x,
        'successes_y':successes_y,
        'logaps': logaps
    }
    return output
