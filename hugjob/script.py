import time
import numpy as np
from numpy import zeros, diag, eye, log, vstack, sqrt, save
...
def run_thug_hop(N):
    ...
    samples = x = x0
    while samples.shape[0] <= M:
        thug_samples, _ = HugTangential(x, T, B, N, alpha, q, logpi, grad_log_pi)    # N iterations of Hug
