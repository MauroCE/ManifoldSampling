# Experiment 40: Like 38 but here we use Hug and Thug with full AR process. 
# The aim is to compare C-HMC with Hug/Thug on an ABC-like example.
...
from tangential_hug_functions import HugARrho, HugTangentialARrho
...
if __name__ == "__main__":
    ...
    for i in range(N_RUNS):
        ...
        for j in range(N_EPSILON):
            ...
            # SAMPLE HUG AND THUG
            hug_samples, acceptance_hug = HugARrho(xi0, T_HUG, B_HUG, N_HUG, rho, q, logpi_HUG, grad_HUG)
            thug_samples, acceptance_thug = HugTangentialARrho(xi0, T_THUG, B_THUG, N_THUG, ALPHAS[j], rho, q, logpi_THUG, grad_THUG)
    ...
    ### SAVE ONTO FOLDER (experiment40/ has rho=0.5, dumper9 has rho=0.7, dumper10 has rho=0.9)
    folder = "dumper10/"
